...
public class RecyclerAdapterQuestionDetails extends RecyclerView.Adapter<RecyclerAdapterQuestionDetails.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(RecyclerAdapterQuestionDetails.MyViewHolder holder, final int position) {
        Questions questions = questionsList.get(position);
        commentId = questionsList.get(position).getQuestionId();
        postedUserId = questionsList.get(position).getQuestionUserId();
    ...
    private void deleteUserComment() {
        StringRequest request = new StringRequest(Request.Method.POST, BaseUri + "/home/deleteQuestionComment/" + commentId, new Response.Listener<String>() {
            @Override
