...
public class RecyclerAdapterInterviewDetails extends RecyclerView.Adapter<RecyclerAdapterInterviewDetails.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        commentId = interviewList.get(position).getInterviewId();
        postedUserId = interviewList.get(position).getInterviewUserId();
    ...
    private void deleteUserComment() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, BaseUri + "/home/deleteInterviewComment/" + commentId, new Response.Listener<String>() {
            @Override
