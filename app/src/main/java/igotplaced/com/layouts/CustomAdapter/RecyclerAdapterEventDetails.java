...
public  class RecyclerAdapterEventDetails extends RecyclerView.Adapter<RecyclerAdapterEventDetails.MyViewHolder>{
    ...
    @Override
    public void onBindViewHolder(RecyclerAdapterEventDetails.MyViewHolder holder, final int position) {

        Events events = eventsList.get(position);
        commentId = eventsList.get(position).getEventId();
        postedUserId = eventsList.get(position).getEventUserId();
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("tag", "click" + eventsList.get(position).getEventId());
    ...
    private void deleteUserComment() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, BaseUri + "/home/deleteEventComment/" + commentId, new Response.Listener<String>() {
            @Override
